  ...
  <div class="header_inner">
    ...
    <div class="search">
      <form action="http://localhost:8085/search.html" id="searchForm" name="query" method="GET">
        <input type="text" class="text keyword ac_input" name="keyword" id="keyword" value="" style="color: rgb(153, 153, 153);" onkeydown="if(event.keyCode==13) search_keys('searchForm');" autocomplete="off">
